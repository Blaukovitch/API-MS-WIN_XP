...
//#include <intrin.h>
//#define memset(_Src, _Val, _Size) __stosb((PUCHAR)(_Src), (UCHAR)(_Val), (SIZE_T)(_Size))
//#ifndef _MSC_BUILD 
...
//#endif // _MSC_BUILD 
    ...
    static size_t __cdecl stricmp1(const char* pStr1, const char* pStr2) {
...
//#define RtlZeroMemory(Destination,Length) zeroset1(Destination, Length)
//#pragma optimize("", on)
...
#pragma intrinsic(wcscpy)
    ...
    constexpr auto INT_DIGITS = 17;
    //#pragma intrinsic(ltow)
    static wchar_t* l_to_w(unsigned long i, wchar_t* dsd)
    {
    ...
    static __inline size_t* set_IMPORT_table_DLLNAME__HOOKS_layots(ppool_I ppol_cursor, HMODULE hm, IMAGE_THUNK_DATA* pThunk_data_original_NEXT, size_t* pFST)
    {
